import { StegaBranded } from "@sanity/client/stega";
import { ClientPerspective, ClientReturn, ContentSourceMap, InitializedClientConfig, LiveEvent, QueryParams, SanityClient } from "next-sanity";
/**
 ...
 */
type FetchClientReturnStega<QueryString extends string> = StegaBranded<ClientReturn<QueryString, unknown>>;
/**
 ...
 */
interface DefinedFetchStegaEnabledOptions<QueryString extends string> extends DefinedFetchOptions<QueryString> {
  /**
   * Enables stega encoding of the data. This is typically only used in draft
   * mode with `perspective: 'drafts'` and `@sanity/visual-editing`.
   *
 ...
 * All other options inherit their documentation from {@link DefinedFetchOptions}.
 */
interface DefinedFetchStegaDisabledOptions<QueryString extends string> extends DefinedFetchOptions<QueryString> {
  /**
 ...
 */
interface StrictDefinedFetchOptions<QueryString extends string> extends DefinedFetchOptions<QueryString> {
  /**
   * Content perspective used for the fetch.
   *
 ...
 */
interface StrictDefinedFetchStegaEnabledOptions<QueryString extends string> extends StrictDefinedFetchOptions<QueryString> {
  /**
   * Enables stega encoding of the data. This is typically only used in draft
   * mode with `perspective: 'drafts'` and `@sanity/visual-editing`.
   *
 ...
 * All other options inherit their documentation from {@link StrictDefinedFetchOptions}.
 */
interface StrictDefinedFetchStegaDisabledOptions<QueryString extends string> extends StrictDefinedFetchOptions<QueryString> {
  /**
   * Disables stega encoding for this fetch. The returned `data` keeps clean
   * TypeGen / {@link ClientReturn} types, no `stegaClean` needed.
   */
...
type StrictDefinedFetchType = {
  <const QueryString extends string>(options: StrictDefinedFetchStegaEnabledOptions<QueryString>): DefinedFetchResult<FetchClientReturnStega<QueryString>>;
  <const QueryString extends string>(options: StrictDefinedFetchStegaDisabledOptions<QueryString>): DefinedFetchResult<ClientReturn<QueryString, unknown>>;
  <const QueryString extends string>(options: StrictDefinedFetchOptions<QueryString>): DefinedFetchResult<FetchClientReturnStega<QueryString>>;
};
interface SanityClientConfig extends Pick<InitializedClientConfig, "projectId" | "dataset" | "apiVersion" | "token" | "requestTagPrefix"> {
 ...
 */
type SanityLiveAction = ((unsafeTags: unknown) => Promise<void | "refresh">) | "refresh";
/**
