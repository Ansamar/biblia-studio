import { useTelemetry, InsertMenuPopover } from "../_chunks-es/InsertMenu.js";
import { PointerEvents } from "../_chunks-es/InsertMenu.js";
...
const AddButton = /* @__PURE__ */ styled(Button).withConfig({
  ...
  componentId: "sc-1hw5eex-0"
})(["position:relative;transform:var(--add-button-position);--add-button-position:translateY(0);[data-position='top'] &{--add-button-position:translateY(-50%);}[data-position='right'] &{--add-button-position:translateX(50%);}[data-position='bottom'] &{--add-button-position:translateY(50%);}[data-position='left'] &{--add-button-position:translateX(-50%);}"]), HoverAreaRoot = /* @__PURE__ */ styled(Flex).withConfig({
  displayName: "HoverAreaRoot",
  componentId: "sc-1hw5eex-1"
})(["pointer-events:all;height:var(--hover-area-height);width:var(--hover-area-width);--hover-area-height:100%;--hover-area-width:100%;&[data-position='top'],&[data-position='bottom']{--hover-area-height:48px;}&[data-position='right'],&[data-position='left']{--hover-area-width:48px;}"]), HoverArea = (props) => {
  const $ = c(28), {
    element,
    hoverAreaExtent,
    node,
