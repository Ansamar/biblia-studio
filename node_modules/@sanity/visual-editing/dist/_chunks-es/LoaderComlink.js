...
import { setLoaderComlink, setLoaderClientConfig, setLoaderPerspective, setLoaderVariant } from "./VisualEditing.js";
...
function _temp2() {
  ...
  return setLoaderComlink(loaderComlink), () => {
    stop(), setLoaderComlink(null), setLoaderClientConfig(null, null), setLoaderPerspective(null), setLoaderVariant(null);
  };
}
function _temp(data) {
  setLoaderClientConfig(data.projectId, data.dataset), setLoaderPerspective(data.perspective), setLoaderVariant(data.variant ?? null);
}
